...
function js_insert_bbcode($form_field = '')
{
    ...
    <script type="text/javascript">
        function getFormData(name_attr) 
        {
            return document.getElementById(name_attr);
        }
        function insert_bbcode(bbopen, bbclose)
        {
            var input = getFormData('<?= $form_field ?>');
            input.focus();
...
function get_bbcode_buttons($bbcode = NULL)
{
    ...
    {
        $button[] = '<button type="button" class="btn btn-primary btn-rich fa fa-'.$key.'" id="'.$key.'" onClick="'.$val.'"></button>';
    }
